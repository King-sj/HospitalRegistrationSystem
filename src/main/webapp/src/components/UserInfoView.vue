...
<template>
  <el-row>
    <div id="change-UserType">
      ...
      <el-select v-model="userType" placeholder="Select" size="small" style="width: 240px">
  ...
  <el-row>
    <div id="change-Gender">
      <el-text>性别 </el-text>
      <el-select v-model="gender" placeholder="Select" size="small" style="width: 240px">
